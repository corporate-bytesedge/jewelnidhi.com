...
@section('title')
	{{$page->meta_title ? $page->meta_title : $page->title." - ".config('app.name')}}
@endsection

@section('meta-tags')
	<meta name="description" content="{{$page->meta_desc ? $page->meta_desc : StringHelper::truncate(trim(strip_tags($page->content)), 160)}}">
...
<div class="container">
	<div class="row">
		<div class="col-md-12 about-us-page">
			<h1 class="about-title_h1"><span> {{ $page->title }} </span></h1>
