                    ...
                    <div class="sub-menu">
                      <div class="inner-menu">
                        ...
                        <div class="menu-box second">
                          ...
                          <ul>
                            <li>
                              <a  href="/category/{{ $value->slug }}/gemstone"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> GEMSTONE</span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/solitaire"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> SOLITAIRE </span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/diamond"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> DIAMOND </span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/platinum"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> PLATINUM </span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/yellow-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> YELLOW GOLD </span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/white-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> WHITE GOLD </span></a>
                            </li>
                            <li>
                              <a href="/category/{{ $value->slug }}/rose-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> <span> ROSE GOLD </span></a>
                            </li>
                                      ...
                                      <li class="menu-item-has-children"><a href="/category/{{ $value->slug }}">{{ $value->name }}</a>
                                        <ul class="dropdown">
                                          ...
                                          <li class="menu-item-has-children"><a href="#">SHOP BY METAL & STONE</a>
                                              <ul class="dropdown">
                                                <li>
                                                  <a  href="/category/{{ $value->slug }}/gemstone"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> GEMSTONE</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/solitaire"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> SOLITAIRE</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/diamond"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> DIAMOND</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/platinum"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> PLATINUM</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/yellow-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> YELLOW GOLD</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/white-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> WHITE GOLD</a>
                                                </li>
                                                <li>
                                                  <a href="/category/{{ $value->slug }}/rose-gold"><img src="{{ URL::asset('img/stone.png') }}" alt=""/> ROSE GOLD</a>
                                                </li>
                                              </ul>
                                          </li>
                                          @if($value->min_price!='0' && $value->max_price!='0')
                          ...
                          <li>
                              <div class="dropdown mobile-top-dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="myaccount">
                                      ...
                                      <a class="dropdown-item login-button" href="javascript:void();"> @lang('Login')</a>
                                      <a class="dropdown-item" href="javascript:void();">register</a>
                                  </div>
                              </div>
                          </li>
                      </ul>
                      ...
                      error :function( data ) {
                        if( data.status === 422 ) {
                          ...
                          $.each( errors.errors, function( key, value ) {
                            if(value[0] == 'The phone field is required.') {
                              value[0] = 'Enter your email or mobile no.';
        ...
        <form  class="form-horizontal" name="registerform" id="registerform" method="POST" action="">
         <input type="hidden" name="is_term_service" id="is_term_service" value="0">  
          ...
          <div class="forgot-link register-link">
            <p>Already have an account? <a href="javascript:void(0)" data-toggle="modal" data-target="#login-modal">Login</a></p>
          </div>
        </form>
         <script>
         jQuery(document).ready(function() {
