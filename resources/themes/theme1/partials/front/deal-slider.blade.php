<section class="well margin-60">
    <div class="large-12 titel-columns">
        <div class="col-sm-12"><h2> <span> <a class="title-slider" href="{{route('front.deal.show', $dealSlug)}}" data-toggle="tooltip" title="View all {{$titleSlider}}">{{$titleSlider}}</a> </span> </h2></div>
    </div>
    <div class="clearfix"></div>
        <div class="swiper-container deal-swiper-{{$index}}">
