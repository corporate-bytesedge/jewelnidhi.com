<header>
  <div class="top-scroll-sec">
    <div class="scroll-rate-sec">
      <p class="1_slider">Today’s Gold rate 22K per gm:  {{ isset($gold_rate->value) ? currency_format(number_format($gold_rate->value)) : currency_format('0.00') }}</p>
       
      <p class="inactive 2_slider"> Today’s Silver rate per gm: {{ isset($silver_rate->value) ? currency_format(number_format($silver_rate->value)) : currency_format('0.00') }}</p>
      <!-- <p class="inactive 3_slider"> Today’s Platinum rate per gm: {{ isset($silver_rate->value) ? currency_format(number_format($silver_rate->value)) : currency_format('0.00') }}</p> -->
                      ...
                      <div class="inner-menu">
                              ...
                              @endphp
                                  <li>
                                    <a href="/category/{{ $val->slug }}">
                                      ...
                                      @else
                                        <img src="{{ asset('img/noimage.png') }} " style="max-width:20px!important;" >
                                      @endif
                                      <span>{{ $val->name }}</span>
                                    </a>
                                  </li>
                        ...
                        <div class="menu-box third">
                          ...
                          <ul>
                            ...
                            @if(isset($start))
                              <li><a href="/filter/{{ $value->slug }}/0/{{ $start }}">Below  {{  number_format($start) }} </a></li>
                            @endif
                            ...
                            @endfor
                            @if(isset($end))
                            <li><a href="/filter/{{ $value->slug }}/{{ $end }}">  {{  number_format($end) }} and above </a></li>
                            @endif
                          </ul>
                        </div>
                        @endif
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <span id="forgoterrmsg" style="color:#D3A012;"></span>
          <div class="form-group  input-group{{ $errors->has('username') || $errors->has('email') ? ' has-error' : '' }}">
            <input type="text" class="form-control " name="forgot_mobile" id="forgot_mobile" placeholder="@lang('Your Mobile')"/>
          ...
          <div class="form-group">
            <button id="forgot_button" type="button"  class="btn btn-primary">@lang('Forgot Password')</button>
          </div>
          <div class="forgot-link">
            <!-- <a href="{{ route('password.request') }}">@lang('Forgot Your Password?')</a> -->
            <p>Already have an account? <a href="javascript:void(0)" data-dismiss="modal" data-toggle="modal" data-target="#login-modal">Login</a></p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" name="" id="" action="">
          <div class="form-group input-group{{ $errors->has('otp') ? ' has-error' : '' }}">
            <input type="number" class="form-control" name="forgot_otp" id="forgot_otp" placeholder="@lang('Ente Your OTP')"/>
            @if ($errors->has('otp'))
                <span class="help-block">
                    <strong class="text-danger">
                        {{ $errors->first('otp') }}
          ...
          <div class="form-group">
            <button id="verify_forgot_otp_Btn" type="button"  class="btn btn-primary">@lang('Verify')</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" name="" id="" action="">
          ...
          <div class="form-group input-group{{ $errors->has('password') ? ' has-error' : '' }}">
              <input placeholder="@lang('Retype New Password*')" type="password" class="form-control" id="new_password_confirmation" name="new_password_confirmation">
          </div>
          <div class="form-group">
            <button id="change_password_Btn" type="button"  class="btn btn-primary">@lang('Change Password')</button>
          </div>
        </form>
      </div>
    </div>
...
<script type="text/javascript">
  jQuery(document).ready(function() {
	...
	$("#verify_forgot_otp_Btn").on("click",function() {
      ...
      $.ajax({
        type:"POST",
        url:"{{ route('front.verify_forgot_otp') }}",
        dataType: "JSON",
