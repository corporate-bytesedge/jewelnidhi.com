                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($order->is_processed =='1')
                                                        <span class="text-primary">@lang('Refunded')</span>
                                                    ...
                                                    @elseif($row->is_not_online_payment() && $row->paid == 0)
                                                ...
                                                @php 
                                                    ...
                                                    $orderTotal = $order->total -  ($order->coupon_amount + $order->wallet_amount);
                                                @endphp
                                                <i class="fa fa-rupee"></i> {{ \App\Helpers\IndianCurrencyHelper::IND_money_format($orderTotal) }}
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    @endphp
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $product->jn_web_id }}</td>
                                                                            <td><a target="_blank" href="{{route('front.product.show', [$product->slug])}}">{{$product->name}}</a></td>
                                                                            
                                                                            <td> <i class="fa fa-rupee"></i>{{ isset($totalPrice) && $totalPrice!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($totalPrice) : '0' }}
                                                                            </td>
                                                                            ...
                                                                            @endphp
                                                                            <i class="fa fa-rupee"></i>{{ isset($totalPriceAmount) && $totalPriceAmount!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($totalPriceAmount) : '0' }}
                                                                            </td>
                                                                        </tr>   
                                                                        @endforeach
                                                                        ...
                                                                        @endphp
                                                                        <tr>
                                                                            <td align="right" colspan="5"><strong>@lang('Sub Total:')</strong></td>
                                                                            <th> 
                                                                                <i class="fa fa-rupee"></i>{{ isset($subTotal) && $subTotal!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($subTotal) : '0' }}
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td  align="right" colspan="5"><strong>@lang('GST')</strong></td>
                                                                            <th> 
                                                                                <i class="fa fa-rupee"></i>{{ isset($GST) && $GST!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format(round($GST)) : '0' }}
                                                                            </th>
                                                                        </tr>

                                                                        <tr>
                                                                            <td  align="right" colspan="5"><strong>@lang('Value Added')</strong></td>
                                                                            <th> 
                                                                                <i class="fa fa-rupee"></i>{{ isset($valueAdded) && $valueAdded!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format(round($valueAdded)) : '0' }}
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td  align="right" colspan="5"><strong>@lang('Order Total:')</strong></td>
                                                                            <th> 
                                                                                <i class="fa fa-rupee"></i>{{ isset($orderTotal) && $orderTotal!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($orderTotal) : '0' }}
                                                                        ...
                                                                        <tr>
                                                                            <td  align="right" colspan="5"><strong>@lang('Shipping Cost:')</strong></td>
                                                                        ...
                                                                        @if($order->wallet_amount && $order->wallet_amount > 0)
                                                                            <tr>
                                                                                <td  align="right" colspan="5"><strong>@lang('Wallet Used:')</strong></td>
                                                                                <th> 
                                                                                <i class="fa fa-rupee"></i> {{ isset($order->wallet_amount) && $order->wallet_amount!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($order->wallet_amount) : '0' }}
                                                                                </th>
                                                                            </tr>
                                                                        @endif
                                                                        @if($order->coupon_amount && $order->coupon_amount > 0)
                                                                            <tr>
                                                                                <td  align="right" colspan="5"><strong>@lang('Coupon Discount:')</strong></td>
                                                                                <th> 
                                                                                <i class="fa fa-rupee"></i> {{ isset($order->coupon_amount) && $order->coupon_amount!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format(number_format($order->coupon_amount)) : '0' }}
                                                                        ...
                                                                        <tr>
                                                                            <td  align="right" colspan="5"><strong>@lang('Total After Discount:')</strong></td>
                                                                            <th> 
                                                                            
                                                                            <i class="fa fa-rupee"></i>{{ isset($totalAmount) && $totalAmount!='0' ? \App\Helpers\IndianCurrencyHelper::IND_money_format($totalAmount) : '0' }}
                                                                              </th>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
