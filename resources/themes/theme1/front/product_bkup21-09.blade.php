...
<title>{{ isset($product->meta_title) ? $product->meta_title : $product->name." - ".config('app.name') }}</title>
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="sp-img_area">
                ...
                @if(isset($product->photo->name) && $product->photo->name)
                  @php
                    $image_url = \App\Helpers\Helper::check_image_avatar($product->photo->name, 80);
                  @endphp
                ...
                @if(isset($product->overlayphoto->name) && $product->overlayphoto->name)
                  @php 
        ...
        <div class="col-md-7">
          <div class="product-details-desc">
           ...
           @else
                <div class="price-box">
                  ...
                  {{ currency_format(number_format($product->old_price)) }}</span>
                </div>
           @endif
           ...
           @endif
            ...
            @if (empty(array_filter($groupSizeArr)) && ($product->category->name == 'Gold' || $product->category->name == 'Diamond'  || $product->category->name == 'Platinum' || $product->category->name == 'Silver Articles' || $product->category->name == 'Silver Jewellery') && $category->name == 'Rings' || $category->name == 'Ring' )
            ...
            <div class="d-flex flex-wrap">
              ...
              @if ( !empty(array_filter($groupSizeArr)))
                  ...
                  <div class="pro-size mr-3">
                      ...
                      <!-- <a href="javascript:void();"   data-toggle="modal" data-target="#exampleModal-bd-example-modal-lg"><strong>Size Guide</strong></a> -->
                      <a href="{{ route('front.product.sizeguide') }}"   target="_blank"><strong>Size Guide</strong></a>
          ...
          <div class="add-to-cart">
              <button class="btn btn-primary" id="add_cart" name="submit_button" type="button">@lang('Add to Cart')</button>
                @if((\Auth::user())  || (!empty(\Auth::user()->mobile) && \Auth::user()->mobile->verified == 1)  || isset(\Auth::user()->verified) &&  \Auth::user()->verified == 1 && \Auth::user()->is_active == 1) 
              ...
              <div class="table-responsive" >
                ...
                <div class="table-responsive">
                    ...
                    @if($product->specificationTypes)
                      ...
                      @foreach($product->specificationTypes AS $k=> $value)
                          @if($value->id =='14' || $value->id =='15' || $value->id =='23'  || $value->id =='38' || $value->id=='27' || $value->id == '40' || $value->id == '52' || $value->id == '55' || $value->id == '57' || $value->id == '70' || $value->id == '74' || $value->id == '76' )
                ...
                @if($product->specificationTypes)
                    @php $priceId = ''; @endphp
                      ...
                      @foreach($product->specificationTypes AS $k=> $value)
                            ...
                            @if($value->id =='16'  || $value->id =='46' || $value->id =='36' || $value->id =='24' || $value->id =='59'    || $value->id =='33' || $value->id =='65'  )
                    ...
                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                      ...
                      @if(isset($val->product_discount) && $val->product_discount!='')
                          ...
                          @if($val->old_price!='')
                            ...
                            @endif  
                              <span class="price-regular" style="font-size: 13px;"> {{ isset($val->new_price) && $val->new_price!='' ? currency_format(number_format($val->new_price)) : '' }}</span>
                          </div>
                          @else
                          <div class="price-box">
