	...
	<div class="row">
		<div class="col-md-12 about-us-page" >
			...
			<div class="page-content m-20">
                    ...
                    <div class="col-sm-12">
                        <h2 class="about-title_h1 mb-4">JewelNidhi Ring Size Guide</h2>
                        <p> JewelNidhi ring size handbook would assist you to measure your ring size right at home so you can get your perfect ring to wear comfortably. Below are the common and easy ways to measure your ring size with minimal and available things at home.</p>
                        <h5 class="mb-2"><strong>Method #1 : Knowing your ring size with a string or thread or strip of paper</strong></h5>
                            <ul class="mb-2">
                            ...
                            <i style="color:#D3A012;"><b>Useful tip:</b> When you are opting this method, check the table to compare your measurement with the circumference parameter.
                                </i>
                            <h5 class="mb-2 mt-3"><strong>Method #2 : Knowing your ring size with your old ring</strong></h5>
                            <ul class="mb-2">
                                ...
                                <b>Useful tip:</b> When you are opting this method, check the table to compare your measurement with the diameter parameter.
                                </i>
                ...
                <table class="table">
                    <tr>
                        <td style="padding:0;">
                            <table>
                                <tr class="bg">
                                    <td style="border-bottom:1px solid transparent;"><span style="color:#D3A012;">Ring Size(Indian)</span></td>
                                </tr>
                                <tr class="bg">
