          ...
          <div class="custom-control nopadding" >
              ...
              <a href="javascript:void(0);" class="addAddress" style="color:#D3A012;" onclick="addAddress();">Add Address </a>
                ...
                {!! Form::open(['method'=>'post', 'action'=>'FrontCustomersController@startPaymentSession','id'=>'customerPaymentForm', 'onsubmit'=>'submit_button.disabled = true; submit_button.value = "' . __('Please Wait') . '"; return true;']) !!}
                  ...
                  @foreach($addresses->unique('first_name') as $key => $address)
                    <div class="radio">
                        <label>
          ...
          <div class="panel panel-primary {{ count($addresses) > 0 ? 'd-none' : '' }}  shipping-details-form mt-2 nopadding" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('state', $states, null, ['class'=>'form-control','id'=>'state','placeholder' => 'Select state', 'required']) !!}
              ...
              <div class="col-md-6">
                          ...
                          @endphp
                            @foreach($cartItems as $k=> $cartItem)
                              ...
                              <tr>
                                  ...
                                  <td class="pro-subtotal"><span> <i class="fa fa-rupee"></i> {!! \App\Helpers\IndianCurrencyHelper::IND_money_format($productamount) !!}</span></td>
                              </tr>
                  ...
                  @php 
                      ...
                      $cartTotal += config('settings.shipping_cost') + round($subTotal) + round($GST) + round($valueAdded) ;
                  @endphp
                      ...
                      <div class="table-responsive mt-2">
                          <table class="table table-bordered mb-0">
                              <tbody><tr>
                                  <td>Sub Total</td>
                                  <td>
                                  <i class="fa fa-rupee"></i> {!! \App\Helpers\IndianCurrencyHelper::IND_money_format(round($subTotal)) !!}
                                  </td>
                              </tr>
                                    <tr>
                                        <td>@lang('GST')</td>
                                        <td>  
                                        <i class="fa fa-rupee"></i> {!! \App\Helpers\IndianCurrencyHelper::IND_money_format(round($GST)) !!}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <i class="fa fa-rupee"></i> {!! \App\Helpers\IndianCurrencyHelper::IND_money_format(round($valueAdded)) !!}
                                        </td>
                                    </tr>
                              ...
                              @if(session()->has('coupon_amount') || session()->has('coupon_percent') && session()->has('coupon_valid_above_amount') && session('coupon_valid_above_amount') < Cart::total())
                                        ...
                                        @if(session('coupon_amount'))
                                            <tr>
                                                ...
                                                <td>-  ₹ {!! \App\Helpers\IndianCurrencyHelper::IND_money_format(session('coupon_amount')) !!} 
                                                 </td>
                                            </tr>
                                        @else
                                        @php 
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td>-  ₹ {!! \App\Helpers\IndianCurrencyHelper::IND_money_format(session('coupon_amount')) !!} </td>
                                            </tr>
                                        @endif
                                  @endif
                                  ...
                                  <tr class="total">
                                    ...
                                    <td class="total-amount">{!! \App\Helpers\IndianCurrencyHelper::IND_money_format($cartTotal - session('coupon_amount')  - $cal_wallet_amount) !!} </td>
                                  </tr>
                                  @php 
                    ...
                    <div class="payment-method-name mb-3">
                      <div class="custom-control custom-checkbox mb-3">
                        ...
                        <div class="custom-control custom-radio mt-2">
                            ...
                            <label class="custom-control-label" for="razorpay"><img src="{{asset('img/payment-icon.png')}} " class="img-fluid paypal-card" alt="Paypal">
                            </label>
                        </div>
