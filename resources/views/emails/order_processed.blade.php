...
# {{ config('custom.mail_message_title_order_processed') }}

![]({{asset('/img/'.config('custom.mail_logo'))}})

{{ config('custom.mail_message_order_processed') }} @lang('Your Order Number is :order_id', ['order_id'=>$order->getOrderId()]).
<hr>
