...
@section('page-header-title')
    @lang('Style Settings') 
        ...
        <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_style')}}">@lang('Add Style')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Style Settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.style')
@endsection