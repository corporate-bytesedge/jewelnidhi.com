...
@section('title')
    @lang('Certificate Settings')
@endsection

@section('page-header-title')
    @lang('Certificate Settings') 
    
        <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_certificate')}}">@lang('Add Certificate')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Certificate Settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.certificate')
@endsection