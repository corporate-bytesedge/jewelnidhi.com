...
@section('title')
    @lang('Shop by metal stone settings')
@endsection

@section('page-header-title')
    @lang('Shop by metal stone settings') 
    
        <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_shop_by_metal')}}">@lang('Add Shop by metal stone')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Shop by metal stone settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.shopbymetalstone')
@endsection