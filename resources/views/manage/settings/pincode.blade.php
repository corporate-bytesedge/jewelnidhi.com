...
@section('title')
    @lang('Pincode Settings')
@endsection

@section('page-header-title')
    @lang('Pincode Settings') 
    
        <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_pincode')}}">@lang('Add Pincode')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Pincode Settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.pincode')
@endsection