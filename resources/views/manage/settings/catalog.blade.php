...
@section('title')
    @lang('Catalog Settings')
@endsection

@section('page-header-title')
    @lang('Catalog Settings') 
    
        <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_catalog')}}">@lang('Add Catalog')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Catalog Settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.catalog')
@endsection