...
@section('title')
    @lang('Metal Puirty Settings')
@endsection

@section('page-header-title')
    @lang('Metal Puirty Settings') 
    
        <!-- <a class="btn btn-sm btn-info" href="{{route('manage.settings.create_metal_puirty')}}">@lang('Add Metal Puirty')</a> -->
    
@endsection

@section('page-header-description')
    @lang('View or Change Metal Puirty Settings')
@endsection
...
@section('content')
    @include('partials.manage.settings.metal_puirty')
@endsection