...
@section('page-header-description')
    @lang('View and Manage Products Approval')
@endsection
    ...
    <script>
        $(document).ready(function () {
            ...
            var productstables = $('#products-table').DataTable({
                ...
                "order": [[ 1, "desc" ]],
                ajax: {
                url: "{{ route('manage.products.vendor_product') }}",
                data: function (d) {
                ...
                columns: [
                    ...
                    {data: 'Action', name: 'Action',
                            ...
                            mRender: function (data, type, row) {
                                ...
                                var tempurl = "{{ route('manage.products.vendor_product_edit', ["+row.id+"]) }}";
                                var url = tempurl.replace("+row.id+",row.id);
                                var deletetempurl = "{{ route('manage.products.delete_vendor_product', ["+row.id+"]) }}";
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            @include('partials.manage.products.vendor.index')
        </div>
    </div>
