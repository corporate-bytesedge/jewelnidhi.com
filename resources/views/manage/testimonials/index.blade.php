...
@section('page-header-title')
    ...
    @can('create', App\Testimonial::class)
        <a class="btn btn-sm btn-info" href="{{route('manage.testimonials.create')}}">@lang('Add Testimonial')</a>
    @endcan
@endsection

@section('page-header-description')
    @lang('View and Manage Testimonials')
@endsection
        ...
        <div class="col-md-12">
            @if(session()->has('testimonial_created'))
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <strong>{{session('testimonial_created')}}</strong>
                </div>
            @endif
            @if(session()->has('testimonial_deleted'))
                <div class="alert alert-success alert-dismissible" role="alert">
            ...
            @if(session()->has('testimonial_not_deleted'))
                <div class="alert alert-danger alert-dismissible" role="alert">
                    ...
                    <strong>{{session('testimonial_not_deleted')}}</strong>
                </div>
            @endif
            @include('partials.manage.testimonials.index')
        </div>
    </div>
@endsection