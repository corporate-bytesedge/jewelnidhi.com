...
@section('page-header-title')
    @lang('Silver Item') 
        ...
        <a class="btn btn-sm btn-info" href="{{route('manage.silveritem.create')}}">@lang('Add Silver Item')</a>
    
@endsection

@section('page-header-description')
    @lang('View or Change Silver Item')
@endsection
...
@section('content')
    @include('partials.manage.silveritem.index')
@endsection