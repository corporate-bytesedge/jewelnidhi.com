                                ...
                                <table class="table table-condensed table-bordered">
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-line text-right"><i class="fa fa-rupee"></i> {{ \App\Helpers\IndianCurrencyHelper::IND_money_format($total - $order->wallet_amount - $order->coupon_amount + ($order->total * $order->tax) / 100) }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
