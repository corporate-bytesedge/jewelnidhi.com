<div class="row">
    <div class="col-xs-12 col-sm-8">
        ...
        <hr> -->
         ...
         <div id="fetch_existing_product">
            ...
            <div class="form-group{{ $errors->has('old_price') ? ' has-error' : '' }}">
                ...
                {!! Form::number('old_price', null, ['class'=>'form-control','id'=>'old_price', 'step'=>'any','readonly'=>true, 'placeholder'=>__('Enter Old price'),'required']) !!}
            </div>
        ...
        <div class="form-group">
            {!! Form::submit(__('Add Product'), ['class'=>'btn btn-primary btn-block btnDisable', 'name'=>'submit_button','id'=>'submit_button']) !!}
        </div>
