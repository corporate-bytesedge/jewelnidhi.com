    ...
    <div class="col-xs-12 col-sm-8">
        ...
        <hr> -->
         ...
         <div id="fetch_existing_product">
            ...
            {!! Form::hidden('current_platitum_price',isset($current_platinum_price->value) ? $current_platinum_price->value : '', ['class'=>'form-control','id'=>'current_platitum_price'])!!}
            ...
            <div class="form-group{{ $errors->has('silver_item_id') ? ' has-error' : '' }}" id="silverHtml">
                ...
                <select name="silver_item_id" id="silver_item_id" class="form-control">
                    <option value="">Select Silver Item</option>
                            ...
                            <option  value="1">Silver Items</option>
                            <option  value="2">Silver Jewellery</option>
            ...
            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}" >
                {!! Form::label('price', __('Gold Price:'),['id'=>'priceHtml']) !!}
            ...
            {!! Form::hidden('stone_price', null, ['id'=>'stone_price', 'placeholder'=>__('Stone Price')])!!}
            {!! Form::hidden('pearls_price', null, ['id'=>'pearls_price', 'placeholder'=>__('Pearls Price')])!!}
            {!! Form::hidden('watch_price', null, ['id'=>'watch_price', 'placeholder'=>__('Watch Price')])!!}
            ...
            {!! Form::hidden('diamond_wtcarats_pendant', null, ['id'=>'diamond_wtcarats_pendant', 'placeholder'=>__('diamond_wtcarats_pendant')])!!}
            {!! Form::hidden('diamond_wtcarats_pendant_price', null, ['id'=>'diamond_wtcarats_pendant_price', 'placeholder'=>__('diamond_wtcarats_pendant_price')])!!}
            ...
            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                {!! Form::label('price', __('Discount Price:')) !!} 
                {!! Form::number('new_price', null, ['class'=>'form-control','id'=>'new_price', 'step'=>'any', 'placeholder'=>__('Enter  price'),'readonly'=>true]) !!}
            </div>
            ...
            <div class="product-quantity">
                ...
                <div class="form-group{{ $errors->has('in_stock') ? ' has-error' : '' }}">
                    {!! Form::label('in_stock', __('In stock:')) !!}<em style="color:red;">*</em>
                    {!! Form::number('in_stock', null, ['class'=>'form-control','min'=>'1', 'placeholder'=>__('Enter maximum allowed quantity in stock')]) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::file('photos[]',['class'=>'form-control upload-files-info2', 'multiple', 'style'=>'display: none;','onchange'=>'$("#upload-files-info2").html(moreImagesNames(files))']) !!}
                <span class='label label-info' id="upload-files-info2">@lang('No image chosen')</span>
        ...
        <div class="form-group col-sm-4">
            {!! Form::button(__('Add Product'), ['class'=>'btn btn-success btn-block btnDisable', 'name'=>'submit_button','id'=>'submit_button']) !!}
        </div>
