...
{{--        </span>--}}
        ...
        <div class="form-group{{ $errors->has('currencyconverterapi_key') ? ' has-error' : '' }}">
            ...
            <small><br>@lang('In case you are using payment methods which supports different currencies than currently set.') <a href="https://currencyconverterapi.com/" target="_blank">@lang('Click to get your API key')</a></small>
