<div class="panel panel-default">
    <div class="panel-heading">
        @lang('List Shop by metal stone')
    </div>
    <div class="panel-body">
        <form id="delete-form" action="bulk_shop_by_metal_delete" method="post" class="form-inline">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <input id="delete_all" name="" class="btn fa btn-warning" value="&#xf1d8;"
                               onclick="
                                       if(confirm('@lang('Are you sure you want to delete selected shop metal?')')) {
                    ...
                    @if($shopByMetal)
                        @foreach($shopByMetal as $value)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{route('manage.settings.edit_shop_by_metal_stone', $value->id)}}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    
                                    <a class="btn btn-danger btn-sm" href="{{route('manage.settings.delete_shop_by_metal', $value->id)}}" onclick="return confirm('Are you sure you want to delete metal')">
