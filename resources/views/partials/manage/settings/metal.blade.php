                    ...
                    @if($metals)
                        @foreach($metals as $value)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{route('manage.settings.edit_metal', $value->id)}}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="{{route('manage.settings.delete_metal', $value->id)}}" onclick="return confirm('Are you sure')">
