                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-quantity">
                                            ...
                                            <select name="pro_qty" class="pro_qty" id="pro_qty_{{ $k }}">
                                                <option @php echo $cartItem->qty == '1' ? 'selected="selected"' : ''; @endphp value="1">1</option>
                                                <option @php echo $cartItem->qty == '2' ? 'selected="selected"' : ''; @endphp value="2">2</option>
                                                <option @php echo $cartItem->qty == '3' ? 'selected="selected"' : ''; @endphp value="3">3</option>
                                                <option @php echo $cartItem->qty == '4' ? 'selected="selected"' : ''; @endphp value="4">4</option>
                                                <option @php echo $cartItem->qty == '5' ? 'selected="selected"' : ''; @endphp value="5">5</option>
                                                <option @php echo $cartItem->qty == '6' ? 'selected="selected"' : ''; @endphp value="6">6</option>
                                                <option @php echo $cartItem->qty == '7' ? 'selected="selected"' : ''; @endphp value="7">7</option>
                                                <option @php echo $cartItem->qty == '8' ? 'selected="selected"' : ''; @endphp value="8">8</option>
                                                <option @php echo $cartItem->qty == '9' ? 'selected="selected"' : ''; @endphp value="9">9</option>
                                                <option @php echo $cartItem->qty == '10' ? 'selected="selected"' : ''; @endphp value="10">10</option>
                                            </select>
                                            </div>
                                        </td>
