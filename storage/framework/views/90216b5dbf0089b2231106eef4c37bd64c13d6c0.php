...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('View Number of Products'); ?>
<?php $__env->stopSection(); ?>



<?php $__env->startSection('page-header-description'); ?>
    <h3><?php echo app('translator')->getFromJson('Manage Number of Products'); ?></h3>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php echo $__env->make('partials.manage.no_of_products.index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
