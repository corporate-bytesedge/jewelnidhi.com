...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('Style Settings'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-title'); ?>
    <?php echo app('translator')->getFromJson('Style Settings'); ?> 
     
        <a class="btn btn-sm btn-info" href="<?php echo e(route('manage.settings.create_style')); ?>"><?php echo app('translator')->getFromJson('Add Style'); ?></a>
    
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-description'); ?>
    <?php echo app('translator')->getFromJson('View or Change Style Settings'); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.manage.settings.style', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
