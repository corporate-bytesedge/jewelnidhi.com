...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('Shop by metal stone settings'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-title'); ?>
    <?php echo app('translator')->getFromJson('Shop by metal stone settings'); ?> 
    
        <a class="btn btn-sm btn-info" href="<?php echo e(route('manage.settings.create_shop_by_metal')); ?>"><?php echo app('translator')->getFromJson('Add Shop by metal stone'); ?></a>
    
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-description'); ?>
    <?php echo app('translator')->getFromJson('View or Change Shop by metal stone settings'); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.manage.settings.shopbymetalstone', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
