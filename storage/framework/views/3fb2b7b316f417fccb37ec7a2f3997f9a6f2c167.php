     ...
     <div class="row">
       ...
       <div class="col-md-6">
         ...
         <div class="d-f-detail mt-3">
            ...
            <p>Please contact our customer care executives <?php if(config('settings.contact_number')): ?><?php echo e('@'.config('settings.contact_number')); ?><?php endif; ?>, <?php if(config('settings.contact_email')): ?> <a href="mailto:<?php echo e(config('settings.contact_email')); ?>"><?php echo e(config('settings.contact_email')); ?></a> <?php endif; ?></p>
          </div>
       </div>
                            ...
                            <figure class="product-thumb">
                              ...
                              <?php if(\Auth::user()): ?>
                                ...
                                ?>
                                  ...
                                  <a href="javascript:void(0);" <?php echo $selected == true ? '' :'hidden' ?> data-toggle="tooltip" id="removeBtn_<?php echo e($val->id); ?>" style="color:red " onclick="removeWishlist('<?php echo e($val->id); ?>')"   data-placement="left" title="Removed from your wishlist">
                                        <i class="fa fa-heart"></i>
                                    </a>
