...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('Silver Item'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-title'); ?>
    <?php echo app('translator')->getFromJson('Silver Item'); ?> 
    
        <a class="btn btn-sm btn-info" href="<?php echo e(route('manage.silveritem.create')); ?>"><?php echo app('translator')->getFromJson('Add Silver Item'); ?></a>
    
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-description'); ?>
    <?php echo app('translator')->getFromJson('View or Change Silver Item'); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.manage.silveritem.index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
