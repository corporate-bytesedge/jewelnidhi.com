          ...
          <div class="f-menu">
            ...
            <ul class="social-icon">
              ...
              <?php if(config('settings.social_link_instagram_enable') == '1'): ?>
                <li><a target="_blank" href="<?php echo e(config('settings.social_link_instagram')); ?>"><img src="<?php echo e(URL::asset('img/insta-icon.png')); ?> " alt=""/></a></li>
              <?php endif; ?>
              <?php if(config('settings.social_link_facebook_enable') == '1'): ?>
                <?php /* <li><a target="_blank" href="<?php echo e(config('settings.social_link_facebook')); ?>"><img src="<?php echo e(URL::asset('img/facebook.png')); ?>" alt=""/></a></li> */ ?>
				<li><a target="_blank" href="https://www.facebook.com/jewelnidhi.jn"><img src="<?php echo e(URL::asset('img/facebook.png')); ?>" alt=""/></a></li>
              <?php endif; ?>
              <?php if(config('settings.social_link_twitter_enable') == '1'): ?>
                <li><a target="_blank" href="<?php echo e(config('settings.social_link_twitter')); ?>"><img src="<?php echo e(URL::asset('img/twitter.png')); ?> " alt=""/></a></li>
              <?php endif; ?>
              <?php if(config('settings.social_link_youtube_enable') == '1'): ?>
                <?php /* <li><a target="_blank" href="<?php echo e(config('settings.social_link_youtube')); ?>"><img src="<?php echo e(URL::asset('img/youtube.png')); ?>" alt=""/></a></li> */ ?>
				<li><a target="_blank" href="https://www.youtube.com/channel/UCeQ2u1Eh_HvG33-i8IN9rwg"><img src="<?php echo e(URL::asset('img/youtube.png')); ?>" alt=""/></a></li>
              <?php endif; ?>
              
              <?php if(config('settings.social_link_pintrest_enable') == '1'): ?>
                <?php /*<li><a target="_blank" href="<?php echo e(config('settings.social_link_pintrest')); ?>"><i class="fa fa-pinterest-p"></i></a></li> */ ?>
				<li><a target="_blank" href="https://www.pinterest.com/jewelnidhi"><i class="fa fa-pinterest-p"></i></a></li>
              <?php endif; ?>
              <?php if(config('settings.social_link_whatsapp_enable') == '1'): ?>
                <li><a target="_blank" href="https://api.whatsapp.com/send?phone=917059123454&amp;text=Hello"><i class="fa fa-whatsapp"></i></a></li>
              <?php endif; ?>
            </ul>
          </div>
        </div>
