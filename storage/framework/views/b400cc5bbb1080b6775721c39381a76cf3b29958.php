...
<?php $__env->stopSection(); ?>
 <?php if(count($products) > 0 ): ?>
  <div class="row">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <?php endif; ?>
                                  <figure class="product-thumb">
                                      ...
                                      <div class="button-group">
                                            ...
                                            <a href="javascript:void(0);" <?php echo $selected == true ? '' :'hidden' ?>  id="removeBtn_<?php echo e($val->id); ?>" data-toggle="tooltip" style="color:red " onclick="removeWishlist('<?php echo e($val->id); ?>')"   data-placement="left" title="Remove from your wishlist">
