        ...
        <div class="menu-bar main-menu">
          <ul class="menu">
                    ...
                    <div class="sub-menu">
                      <div class="inner-menu">
                        <div class="menu-box first">
                         ...
                         ?>
                         <?php if($value->name != 'Silver Articles'  && $value->name != 'Gems' ): ?>
            ...
            <?php if(config('settings.contact_number')): ?>
              <span class="call-no"><i class="fa fa-phone"></i> <?php echo e(config('settings.contact_number')); ?></span>
            <?php endif; ?>
        </div>      
     </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" name="loginform" id="loginform" action="">
          ...
          <div class="form-group">
            <button id="login-button" type="button"  class="btn btn-primary login-button"><?php echo app('translator')->getFromJson('Reset Password'); ?></button>
          </div>
