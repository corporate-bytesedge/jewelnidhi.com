...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('View Home Banner'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <?php endif; ?>
            <?php echo $__env->make('partials.manage.home-banner.index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
<?php $__env->stopSection(); ?>
