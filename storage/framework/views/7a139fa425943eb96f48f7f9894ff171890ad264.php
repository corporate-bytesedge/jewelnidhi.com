...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('Edit Vendor Product'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-title'); ?>
    <?php echo app('translator')->getFromJson('Edit Products Approval'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-description'); ?>
    <?php echo app('translator')->getFromJson('Edit Products Approval'); ?> <a href="<?php echo e(route('manage.products.vendor_product')); ?>"><?php echo app('translator')->getFromJson('Go Back'); ?></a>
<?php $__env->stopSection(); ?>
            ...
            $.validator.addMethod("checkWebID", 
                function(value, element) {
                    ...
                    $.ajax({
                        type:"GET",
                        async: false,
                        url: "<?php echo e(route('manage.checkvendorproductwebid')); ?>", // script to validate in server side
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.manage.products.vendor.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
