...
<div class="category-page">
  ...
  <div class="category-head">
      ...
      <span><?php echo e(count($allProduct)); ?> Designs</span><?php echo e($product_max_price); ?> <?php echo e($product_min_price); ?>
              ...
              <select class="nice-select" data-slug="<?php echo e(request()->get('keyword')); ?>" id="metalFilter">
                ...
                <?php if(!empty($metal)): ?>
                  <?php $__currentLoopData = $metal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option data-metal="<?php echo e($value['name']); ?>" value="<?php echo e($value['id']); ?>"><?php echo e($value['name']); ?> ( <?php echo e($value['count']); ?> )  </option>
