...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('Certificate Settings'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-title'); ?>
    <?php echo app('translator')->getFromJson('Certificate Settings'); ?> 
    
        <a class="btn btn-sm btn-info" href="<?php echo e(route('manage.settings.create_certificate')); ?>"><?php echo app('translator')->getFromJson('Add Certificate'); ?></a>
    
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-header-description'); ?>
    <?php echo app('translator')->getFromJson('View or Change Certificate Settings'); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('partials.manage.settings.certificate', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
